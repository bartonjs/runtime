...
namespace System.Security.Cryptography.Asn1
{
    ...
    internal partial struct RSAPublicKeyAsn
    {
        ...
        internal static RSAPublicKeyAsn Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet)
        {
            return Decode(Asn1Tag.Sequence, encoded, ruleSet);
        }

        internal static RSAPublicKeyAsn Decode(Asn1Tag expectedTag, ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet)
        {
            try
            {
