...
namespace System.DirectoryServices.Protocols
{
    ...
    internal enum LdapOption
    {
        ...
        LDAP_OPT_X_TLS_PACKAGE = 0x6011, // Not Supported in Windows
        LDAP_OPT_X_TLS_NEWCTX = 0x600F, // Not Supported in Windows
        LDAP_OPT_X_TLS_CONNECT_CB = 0x6014, // Not Supported in Windows
        LDAP_OPT_X_TLS_CONNECT_ARG = 0x6015, // Not Supported in Windows
