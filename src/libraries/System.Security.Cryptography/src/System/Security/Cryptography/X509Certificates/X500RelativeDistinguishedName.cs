...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public sealed class X500RelativeDistinguishedName
    {
        ...
        /// <summary>
        ///   When applicable, gets the object identifier (OID) identifying the single attribute
        ///   value for this Relative Distinguished Name.
        /// </summary>
        /// <value>
        ///   The object identifier (OID) identifying the single attribute value for this Relative
        ///   Distinguished Name (RDN), or <see langword="null"/> if the RDN has multiple attributes.
        /// </value>
        ...
        ///   The Relative Distinguished Name has multiple attributes (<see cref="HasMultipleValues"/>
        ///   is <see langword="true" />).
        /// </exception>
        public string? GetSingleValueValue()
        {
            if (_singleValueValue.IsEmpty)
            {
                throw new InvalidOperationException(
                    "Something about multi-valued RDNs not being Single-Value");
            }
            ...
            try
            {
                AsnValueReader reader = new AsnValueReader(_singleValueValue.Span, AsnEncodingRules.BER);
