...
namespace System.Security.Cryptography
{
    ...
    public abstract partial class Hpke : System.IDisposable
    {
        ...
        public byte[] Open(byte[] encapsulatedKey, byte[] ciphertext, byte[]? aad = null, byte[]? info = null) { throw null; }
        public byte[] Open(System.ReadOnlySpan<byte> encapsulatedKey, System.ReadOnlySpan<byte> ciphertext, System.ReadOnlySpan<byte> aad = default(System.ReadOnlySpan<byte>), System.ReadOnlySpan<byte> info = default(System.ReadOnlySpan<byte>)) { throw null; }
        public void Open(System.ReadOnlySpan<byte> encapsulatedKey, System.ReadOnlySpan<byte> ciphertext, System.Span<byte> plaintext, System.ReadOnlySpan<byte> aad = default(System.ReadOnlySpan<byte>), System.ReadOnlySpan<byte> info = default(System.ReadOnlySpan<byte>)) { }
        protected abstract void OpenCore(System.ReadOnlySpan<byte> encapsulatedKey, System.ReadOnlySpan<byte> ciphertext, System.Span<byte> plaintext, System.ReadOnlySpan<byte> aad, System.ReadOnlySpan<byte> info);
        public void Seal(byte[] plaintext, out byte[] encapsulatedKey, out byte[] ciphertext, byte[]? aad = null, byte[]? info = null) { throw null; }
