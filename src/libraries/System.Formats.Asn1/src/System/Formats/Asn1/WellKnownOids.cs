...
namespace System.Formats.Asn1
{
    internal static class WellKnownOids
    {
        ...
        private static ReadOnlySpan<byte> RC2 =>
        ...
        private static ReadOnlySpan<byte> KeyIdentifier =>
            new byte[] { 0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x11, 0x03, };
        ...
        internal static string? GetValue(ReadOnlySpan<byte> contents)
        {
            return contents switch
            {
                ...
                [ 0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x11, 0x03, ] => "1.3.6.1.4.1.311.17.3",
        ...
        internal static ReadOnlySpan<byte> GetContents(string value)
        {
            return value switch
            {
                ...
                "1.3.6.1.4.1.311.17.3" => KeyIdentifier,
