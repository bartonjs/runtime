...
static const Entry s_cryptoNative[] =
{
    ...
    DllImportEntry(CryptoNative_DecodeRsaPkcs8)
    ...
    DllImportEntry(CryptoNative_EvpPKeyKeySize)
    ...
    DllImportEntry(CryptoNative_ExportRSAPrivateKey)
    DllImportEntry(CryptoNative_ExportRSAPublicKey)
